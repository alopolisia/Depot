    ...
    <div class="mkd-video-wrap">
        <video class="mkd-self-hosted-video" poster="<?php echo esc_url($media['video_cover']); ?>" preload="auto">
            ...
            <object width="320" height="240" type="application/x-shockwave-flash" data="<?php echo esc_url(get_template_directory_uri().'/js/flashmediaelement.swf'); ?>">
                ...
                <img src="<?php echo esc_url($media['video_cover']); ?>" width="1920" height="800" title="<?php esc_html_e('No video playback capabilities', 'mkd-core'); ?>" alt="<?php esc_html_e('video thumb', 'mkd-core'); ?>"/>
            </object>
        </video>
    </div>
</div>