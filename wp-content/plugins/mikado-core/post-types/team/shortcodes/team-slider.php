...
class TeamSlider implements Lib\ShortcodeInterface {
    ...
    public function __construct() {
        ...
        add_filter( 'vc_autocomplete_mkd_team_slider_category_callback', array( &$this, 'teamCategoryAutocompleteSuggester', ), 10, 1 ); // Get suggestion(find). Must return an array

        //Team category render
        add_filter( 'vc_autocomplete_mkd_team_slider_category_render', array( &$this, 'teamCategoryAutocompleteRender', ), 10, 1 ); // Get suggestion(find). Must return an array

        //Team selected projects filter
        add_filter( 'vc_autocomplete_mkd_team_slider_selected_projects_callback', array( &$this, 'teamIdAutocompleteSuggester', ), 10, 1 ); // Get suggestion(find). Must return an array

        //Team selected projects render
        add_filter( 'vc_autocomplete_mkd_team_slider_selected_projects_render', array( &$this, 'teamIdAutocompleteRender', ), 10, 1 ); // Render exact team. Must return an array (label,value)
    }
    ...
    public function vcMap() {
        vc_map(array(
            'name'                      => esc_html__('Mikado Team Slider', 'mkd-core'),
            'base'                      => $this->base,
            ...
            'params' => array(
                array(
                    ...
                    'heading'     => esc_html__('Number of Columns in Row', 'mkd-core'),
                    'value'       => array(
                ...
                array(
                    'type'        => 'dropdown',
                    'param_name'  => 'dots',
                    'heading'     => esc_html__('Show Navigation Dots', 'mkd-core'),
    ...
    public function render($atts, $content = null) {
        ...
        $html = '';
        $html .= '<div class="mkd-team-slider-holder">';
