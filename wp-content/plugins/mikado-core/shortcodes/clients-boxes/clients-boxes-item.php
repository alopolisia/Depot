<?php
namespace MikadoCore\CPT\Shortcodes\ClientsBoxesItem;
...
class ClientsBoxesItem implements Lib\ShortcodeInterface{
	...
	public function vcMap() {
		vc_map(array(
			'name' => esc_html__('Mikado Clients Boxes Item', 'mkd-core'),
			'base' => $this->getBase(),
			...
			'params' => array(
				...
				array(
					...
					'value'      => array(
						esc_html__('Same Window', 'mkd-core')  => '_self',
						esc_html__('New Window', 'mkd-core') => '_blank'
					),
					'save_always' => true
				)
			)
	...
	public function render($atts, $content = null) {
		...
		$html = mkd_core_get_shortcode_module_template_part('templates/clients-boxes-item', 'clients-boxes', '', $params);
