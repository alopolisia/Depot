<?php
if ( ! function_exists( 'depot_mikado_init_google_fonts_array' ) ) {
    function depot_mikado_init_google_fonts_array() {
    ...
    add_action('after_setup_theme', 'depot_mikado_init_google_fonts_array');
}